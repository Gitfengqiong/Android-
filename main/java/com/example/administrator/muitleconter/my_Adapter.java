...
public class my_Adapter extends BaseAdapter {
    ...
    private SetingActivtiy.AllCheckListener allCheckListener;

    public my_Adapter(List<Model> data, Context context, SetingActivtiy.AllCheckListener allCheckListener) {
        this.data = data;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.spinner_cheek, null);
            hd.textView = (TextView) view.findViewById(R.id.textx);
            hd.checkBox = (CheckBox) view.findViewById(R.id.cbox);
            view.setTag(hd);
        }
