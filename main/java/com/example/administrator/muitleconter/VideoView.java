...
public class VideoView   implements VideoCodec{
    public static void initVideo(SurfaceView V[], SurfaceHolder H[]){
    }

    public class VideoDecoder_Internet  {
        ...
        public VideoDecoder_Internet(Surface surface, Server server)
